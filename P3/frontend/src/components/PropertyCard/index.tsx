...
function PropertyCard(props: {property: Property, state: any}) {
    ...
    if (navigate) {
        var locState = props.state;
        var state: {id: number, locationState: any} = {
        ...
        return <a href="" className="block rounded-lg p-4 shadow-sm shadow-indigo-100" onClick={() => HandleNavigate("/property")}>
            <img
                alt="Home"
